...
abstract class Htj2kImageReader extends AbstractDicomImageReader {
    private final String transferSyntaxUid;

    Htj2kImageReader(ImageReaderSpi provider, String transferSyntaxUid) {
        super(provider);
    ...
    protected BufferedImage readFrame(ImageDescriptor descriptor,
        ...
        return Jpeg2000RasterFrames.toImage(descriptor,
                Htj2kFrameCodec.forTransferSyntax(transferSyntaxUid)
                        .decode(bytes.toByteArray()), param);
    }
}
